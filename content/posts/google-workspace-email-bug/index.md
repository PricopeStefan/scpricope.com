...
[^1]: DKIM signs both email headers and message body, but only the email headers hash is referred to as THE DKIM Signature (and not even all of the headers, just a few of them)
